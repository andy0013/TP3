...
void StrategySolicitud::StrategyEnviarInformacionSolicitadaPorCliente(Socket& socketCliente,std::string line){
	this->solicitud->enviarInfomacionCliente(socketCliente, line);
}

void StrategySolicitud::StrategyRecibirInformacionDelServidor(Socket& socketServer){
